 ...
 */
public class BannerNewLayoutManager extends RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {

    private static final String TAG = "BannerNewLayoutManager";
    ...
    int mOrientation = OrientationHelper.HORIZONTAL;
     ...
     * helps {@link BannerNewLayoutManager} make those decisions.
     */
     ...
     */
    public BannerNewLayoutManager(Context context) {
        this(context, OrientationHelper.HORIZONTAL, false);
    }
     ...
     */
    public BannerNewLayoutManager(Context context, @RecyclerView.Orientation int orientation,
                               boolean reverseLayout) {
        setOrientation(orientation);
        setReverseLayout(reverseLayout);
        this.mHorizontalBoundCheck = new ViewBoundsCheck(mHorizontalBoundCheckCallback);
        this.mVerticalBoundCheck = new ViewBoundsCheck(mVerticalBoundCheckCallback);
    }
...
//        }
     ...
     */
    public BannerNewLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                               int defStyleRes) {
    ...
    /**
     * Sets the orientation of the layout. {@link BannerNewLayoutManager}
     ...
     *
     * <p>By default, {@link BannerNewLayoutManager} lays out 1 extra page
     ...
     * BannerNewLayoutManager} and stores the result in {@code extraLayoutSpace}. {@code
...
//            }
     ...
     * @see BannerNewLayoutManager.LayoutState#mLayoutDirection
     */
     ...
     * independent from the rest of the {@link BannerNewLayoutManager}
